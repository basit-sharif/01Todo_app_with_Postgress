export default function AddBtn() {
    return (
        <svg width="45" height="47" viewBox="0 0 45 47" fill="none" xmlns="http://www.w3.org/2000/svg">
            <ellipse cx="22.5" cy="23.5" rx="22.5" ry="23.5" fill="url(#paint0_linear_0_1)" />
            ...
            <defs>
                <linearGradient id="paint0_linear_0_1" x1="22.5" y1="0" x2="22.5" y2="47" gradientUnits="userSpaceOnUse">
